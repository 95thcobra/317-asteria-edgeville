...
public class Region {
	...
	public static boolean pathBlocked(Npc attacker, Player victim) {
		...
		double offsetX = Math.abs(attacker.absX - victim.getPosition().getX());
		double offsetY = Math.abs(attacker.absY - victim.getPosition().getY());
		...
		while (distance > 0) {
			...
			nextMoveX = 0;
			nextMoveY = 0;
			if (curX > victim.getPosition().getX()) {
			...
			} else if (curX < victim.getPosition().getX()) {
				currentTileXCount += offsetX;
				if (currentTileXCount >= 1.0) {
					nextMoveX++;
					curX++;
			...
			if (curY > victim.getPosition().getY()) {
			...
			} else if (curY < victim.getPosition().getY()) {
				currentTileYCount += offsetY;
				if (currentTileYCount >= 1.0) {
					nextMoveY++;
					curY++;
	...
	public static boolean checkClip(Player c, int endX, int endY) {
		int x = c.getPosition().getX(), y = c.getPosition().getY();
		...
		for (int i = 0; i <= longest; i++) {
			...
			if (!getClipping(currentX, currentY, c.getPosition().getZ(), x - currentX, y - currentY, true)) {
				return false;
			}
			if (x == endX && y == endY) {
				return true;
	...
	public static int getClipping(int x, int y, int height) {
		...
		//System.out.println("GETCLIPPING:(: " + 0);
		return 0;
	}
	...
	public static boolean canAttack(Npc a, Player b) {
	...
	public boolean normalFollow(Player player, Player other) {
		...
		boolean checkClip = Region.checkClip(other,other.getLastPosition().getX(), other.getLastPosition().getY());
		if (!checkClip) {
			int otherX = other.getPosition().getX();
			int otherY = other.getPosition().getY();
			if (Region.checkClip(other, otherX - 1, otherY)) {
				other.getLastPosition().setX(otherX - 1);
				other.getLastPosition().setY(otherY);
			} else if (Region.checkClip(other, otherX + 1, otherY)) {
				other.getLastPosition().setX(otherX + 1);
				other.getLastPosition().setY(otherY);
			} else if (Region.checkClip(other, otherX, otherY - 1)) {
				other.getLastPosition().setX(otherX);
				other.getLastPosition().setY(otherY - 1);
			}
		}
		...
		player.movement
		playerWalk(other.getLastPosition().getX(), other.getLastPosition().getY(), true);
		return true;
	}
	
	public boolean playerWalk(Player c, boolean combatWalk) {
	...
	public static void findRoute(Player c, int destX, int destY, boolean moveNear, int xLength, int yLength) {
		...
		while (tail != tileQueueX.size() && tileQueueX.size() < pathLength) {
			 ...
			 * c.getPosition().getZ() % 4, absDestX, absDestY, xLength, yLength)) {
		...
		int size = tail--;
		c.setResetMovementQueue(true);
		//c.resetWalkingQueue();
		c.getMovementQueue().addToPath(new Position(tileQueueX.get(tail), tileQueueY.get(tail)));
	...
	public static boolean getClipping(int x, int y, int height, int moveTypeX, int moveTypeY, boolean projectile) {
		try {
			...
			if (moveTypeX == -1 && moveTypeY == 0)
				...
				return ((getClipping(checkX, checkY, height, projectile) & 0x128010e) == 0 && (getClipping(checkX, y, height, projectile) & 0x1280108) == 0 && (getClipping(x, checkY, height, projectile) & 0x1280102) == 0);
			else if (moveTypeX == 1 && moveTypeY == -1)
				return ((getClipping(checkX, checkY, height, projectile) & 0x1280183) == 0 && (getClipping(checkX, y, height, projectile) & 0x1280180) == 0 && (getClipping(x, checkY, height, projectile) & 0x1280102) == 0);
			else if (moveTypeX == -1 && moveTypeY == 1)
				return ((getClipping(checkX, checkY, height, projectile) & 0x1280138) == 0 && (getClipping(checkX, y, height, projectile) & 0x1280108) == 0 && (getClipping(x, checkY, height, projectile) & 0x1280120) == 0);
			else if (moveTypeX == 1 && moveTypeY == 1)
				return ((getClipping(checkX, checkY, height, projectile) & 0x12801e0) == 0 && (getClipping(checkX, y, height, projectile) & 0x1280180) == 0 && (getClipping(x, checkY, height, projectile) & 0x1280120) == 0);
			else {
	...
	private static boolean checkTile(int clipData, int objectX, int objectY) {
		...
		if (clipData == 131328) {
			...
			if ((objectX == 3099 || objectX == 3100) && (objectY == 3525 || objectY == 3526))
				return true;
			if ((objectX == 3093 && objectY == 3541) || (objectX == 3082 && objectY == 3537) || (objectX == 3072 && objectY == 3541) || (objectX == 3088 && objectY == 3554) || (objectX == 3083 && objectY == 3553) || (objectX == 3078 && objectY == 3552) || (objectX == 3070 && objectY == 3554) || (objectX == 3064 && objectY == 3551) || (objectX == 3058 && objectY == 3551) || (objectX == 3057 && objectY == 3556) || (objectX == 3054 && objectY == 3562) || (objectX == 3051 && objectY == 3561) || (objectX == 3050 && objectY == 3565) || (objectX == 3044 && objectY == 3566) || (objectX == 3043 && objectY == 3569) || (objectX == 3045 && objectY == 3572) || (objectX == 3045 && objectY == 3577) || (objectX == 3045 && objectY == 3578) || (objectX == 3045 && objectY == 3579) || (objectX == 3044 && objectY == 3579) || (objectX == 3044 && objectY == 3578) || (objectX == 3044 && objectY == 3577) || (objectX == 3336 && objectY == 3665) || (objectX == 3336 && objectY == 3666)
					|| (objectX == 3335 && objectY == 3665) || (objectX == 3337 && objectY == 3664) || (objectX == 3337 && objectY == 3665) || (objectX == 3337 && objectY == 3666) || (objectX == 3337 && objectY == 3667) || (objectX == 3340 && objectY == 3659) || (objectX == 3340 && objectY == 3660) || (objectX == 3341 && objectY == 3659) || (objectX == 3341 && objectY == 3660) || (objectX == 3342 && objectY == 3672) || (objectX == 3344 && objectY == 3672) || (objectX == 3345 && objectY == 3672) || (objectX == 3344 && objectY == 3671) || (objectX == 3345 && objectY == 3671) || (objectX == 3350 && objectY == 3674) || (objectX == 3348 && objectY == 3677) || (objectX == 3348 && objectY == 3678) || (objectX == 3348 && objectY == 3679) || (objectX == 3348 && objectY == 3680) || (objectX == 3347 && objectY == 3678) || (objectX == 3347 && objectY == 3679) || (objectX == 3346 && objectY == 3678) || (objectX == 3342 && objectY == 3691) || (objectX == 3341 && objectY == 3691)
	...
	public static int getClipping(int x, int y, int height, boolean projectile) {
		...
		if (r == null || r.id() != regionId)
			return 0;
		if (projectile) {
			if (r.getClip(x, y, height) == 2228480 || r.getClip(x, y, height) == 4104 || r.getClip(x, y, height) == 131328 || r.getClip(x, y, height) == 2097152 || r.getClip(x, y, height) == 2097408) {
