...
public class ObjectDef {
	...
	public static void loadConfig() {
		Archive archive = Server.fileSystem.getArchive(FileSystem.CONFIG_ARCHIVE);
		stream = new Buffer(archive.getData("loc.dat").array());
		Buffer stream = new Buffer(archive.getData("loc.idx").array());
	...
	public void readValues1(Buffer stream) {
		int flag = -1;
		do {
	...
	public boolean hasOption(String option) {
		if (actions == null || actions.length == 0 || option == null) {
			return false;
		}
